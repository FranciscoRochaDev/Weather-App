...
export default function useWeather () {
    ...
    const fetchWeather = async ({ lat, lon }: Coordinates) => {
        ...
        try {
            const baseUrl = `${apiUrl}latitude=${lat}&longitude=${lon}&hourly=temperature_2m,weathercode,wind_speed_10m,apparent_temperature,relative_humidity_2m,wind_direction_10m,precipitation&daily=weathercode,temperature_2m_max,temperature_2m_min&timezone=auto`
